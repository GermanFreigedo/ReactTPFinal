            ...
            <div className="row my-5">
                <div className="col-md-6">
                    <form>
                        ...
                        <div className="mb-3">
                            <label for="email" className="form-label">Reingrese el Email</label>
                            <input type="text" className="form-control" id="email2" placeholder="Reingrese el Email" onInput={(e) => {setEmail(e.target.value)}} />
                        </div>
